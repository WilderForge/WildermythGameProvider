...
public class WildermythGameProviderOLD implements GameProvider {

	private static final String[] ALLOWED_EARLY_CLASS_PREFIXES = {"com.wildermods.provider.services.CrashLogService", "net.fabricmc.loader.impl.util.log.", "org.spongepowered", "com.llamalad7.mixinextras"};
